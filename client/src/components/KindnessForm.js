					...
					<div className='row'>
						...
						<div className='proposal-field'>
							...
							<form onSubmit={this.handleIntroductionTag}>
								...
								{
									introductionTags && introductionTags.map(tag => <Tags tag={tag.name}/>)
								}
								<input
						...
						<form onSubmit={this.handleFeedbackTag}>
							...
							{
								feedbackTags && feedbackTags.map(tag => <Tags tag={tag.name}/>)
							}
							<input
						...
						<form onSubmit={this.handleResourcesTag}>
							...
							{
								resourcesTags && resourcesTags.map(tag => <Tags tag={tag.name}/>)
							}
							<input
